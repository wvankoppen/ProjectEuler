...
function hasEqualSubsets(set) {
    const subsets = createSubsets(set);
...
const sets = [[81,88,75,42,87,84,86,65],
...
// const r = sets.reduce((acc,curr) => {
//     if (!hasEqualSubsets(curr)) {
//         l(curr);
//         acc += curr.reduce((a,b) => a+b);
//     }
//     return acc;
// },0)
// l(r);
